...
cp -p "release/B-Roll Recorder-0.1.5-mac-x64.dmg" /tmp/broll-release/B-Roll-Recorder-0.1.5-mac-x64.dmg
cp -p "release/B-Roll Recorder-0.1.5-mac-x64.dmg.blockmap" /tmp/broll-release/B-Roll-Recorder-0.1.5-mac-x64.dmg.blockmap
cp -p "release/B-Roll Recorder-0.1.5-mac-x64.zip" /tmp/broll-release/B-Roll-Recorder-0.1.5-mac-x64.zip
cp -p "release/B-Roll Recorder-0.1.5-mac-x64.zip.blockmap" /tmp/broll-release/B-Roll-Recorder-0.1.5-mac-x64.zip.blockmap
cp -p release/latest-mac.yml /tmp/broll-release/latest-mac.yml
gh release upload v0.1.5 --repo mojo-codes/broll-recorder --clobber /tmp/broll-release/*
```
